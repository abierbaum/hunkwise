...
describe('HunkwiseGit', () => {
  ...
  describe('settings', () => {
    ...
    it('round-trips settings', () => {
      ...
      const g2 = new HunkwiseGit(path.join(dir2, '.vscode', 'hunkwise'), dir2);
      g2.saveSettings({ ignorePatterns: ['node_modules', 'dist'], respectGitignore: false, clearOnBranchSwitch: false, quoteRotationInterval: 60, useDiffEditor: false, showInlineDecorations: true, showDiffHeaderButtons: true, dynamicRendering: true, showPerfTrace: false });
      const s = g2.loadSettings();
    ...
    it('round-trips quoteRotationInterval set to 0', () => {
      ...
      const g2 = new HunkwiseGit(path.join(dir2, '.vscode', 'hunkwise'), dir2);
      g2.saveSettings({ ignorePatterns: ['.git'], respectGitignore: true, clearOnBranchSwitch: false, quoteRotationInterval: 0, useDiffEditor: false, showInlineDecorations: true, showDiffHeaderButtons: true, dynamicRendering: true, showPerfTrace: false });
      const s = g2.loadSettings();
    ...
    it('round-trips quoteRotationInterval with custom value', () => {
      ...
      const g2 = new HunkwiseGit(path.join(dir2, '.vscode', 'hunkwise'), dir2);
      g2.saveSettings({ ignorePatterns: ['.git'], respectGitignore: true, clearOnBranchSwitch: false, quoteRotationInterval: 30, useDiffEditor: false, showInlineDecorations: true, showDiffHeaderButtons: true, dynamicRendering: true, showPerfTrace: false });
      const s = g2.loadSettings();
    ...
    it('mergeDefaultSettings fills missing fields', () => {
      ...
      const merged = g2.mergeDefaultSettings({ ignorePatterns: ['.git'], respectGitignore: true, clearOnBranchSwitch: false, quoteRotationInterval: 30, useDiffEditor: false, showInlineDecorations: true, showDiffHeaderButtons: true, dynamicRendering: true, showPerfTrace: false });
    ...
    it('mergeDefaultSettings preserves all existing fields', () => {
      ...
      const g2 = new HunkwiseGit(path.join(dir2, '.vscode', 'hunkwise'), dir2);
      g2.saveSettings({ ignorePatterns: ['custom'], respectGitignore: false, clearOnBranchSwitch: false, quoteRotationInterval: 30, useDiffEditor: false, showInlineDecorations: true, showDiffHeaderButtons: true, dynamicRendering: true, showPerfTrace: false });
      const merged = g2.mergeDefaultSettings({ ignorePatterns: ['.git'], respectGitignore: true, clearOnBranchSwitch: false, quoteRotationInterval: 60, useDiffEditor: false, showInlineDecorations: true, showDiffHeaderButtons: true, dynamicRendering: true, showPerfTrace: false });
  ...
  describe('destroyGit', () => {
    ...
    it('preserves settings.json after destroy', async () => {
      ...
      const g2 = new HunkwiseGit(hDir, dir2);
      await g2.initGit();
      g2.saveSettings({ ignorePatterns: ['dist'], respectGitignore: false, clearOnBranchSwitch: false, quoteRotationInterval: 60, useDiffEditor: false, showInlineDecorations: true, showDiffHeaderButtons: true, dynamicRendering: true, showPerfTrace: false });
      g2.destroyGit();
